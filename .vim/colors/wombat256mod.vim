...
hi Search		ctermfg=232		ctermbg=68		cterm=none		guifg=#d787ff	guibg=#636066	gui=none
...
hi TabLineSel ctermfg=15 ctermbg=234 cterm=bold,underline
"hi Tooltip
"hi User1
"hi User9
hi WildMenu ctermfg=232 ctermbg=192
